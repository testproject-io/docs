...
![Obtaining Sauce Labs Username and Access Key](../.gitbook/assets/image%20%2827%29.png)
...
![Configuring Sauce Labs access information in TestProject](../.gitbook/assets/image.png)

Once saved, we will validate that the credentials are correct and close the integration settings window. After the window closes you should see that the integration is active ![](../.gitbook/assets/image%20%2861%29.png) That's it!
...
![Running the &quot;Login&quot; web test on the Sauce Labs Edge 18 browser using Eldar&apos;s Agent](../.gitbook/assets/image%20%2881%29.png)
...
![Defining a job to run using own Agent on locally installed Chrome and on 6 additional Sauce Labs browsers](../.gitbook/assets/image%20%2864%29.png)
...
![Defining a job to run using the Virtual Agent on 6 different Sauce Labs browsers](../.gitbook/assets/image%20%2844%29.png)
...
![TestProject Monitor showing the progress of currently running test on Sauce Labs Edge 44 browser](../.gitbook/assets/image%20%2849%29.png)
...
![A TestProject report of the &quot;Login&quot; test that was executed on Sauce Labs Edge browser](../.gitbook/assets/image%20%2867%29.png)
...
![Sauce Labs &quot;Login&quot; test execution information](../.gitbook/assets/image%20%2898%29.png)
