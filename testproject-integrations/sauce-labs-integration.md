...
![Obtaining Sauce Labs Username and Access Key](../.gitbook/assets/image%20%2860%29.png)
...
Once saved, we will validate that the credentials are correct and close the integration settings window. After the window closes you should see that the integration is active ![](../.gitbook/assets/image%20%28142%29.png) That's it!
...
![Running the &quot;Login&quot; web test on the Chrome 79 browser using Eldar&apos;s Agent](../.gitbook/assets/image%20%28223%29.png)
...
![Running the &quot;Login&quot; web test on the Sauce Labs Edge 18 browser using Eldar&apos;s Agent](../.gitbook/assets/image%20%28187%29.png)
...
![A TestProject Virtual Agent](../.gitbook/assets/image%20%2863%29.png)
...
![Running the &quot;Login&quot; web test on the Sauce Labs Chrome 79 \(on Mac 10.14\) browser using the Virtual Agent](../.gitbook/assets/image%20%28179%29.png)
...
![Defining a job to run using own Agent on locally installed Chrome and on 6 additional Sauce Labs browsers](../.gitbook/assets/image%20%28151%29.png)
...
![Defining a job to run using the Virtual Agent on 6 different Sauce Labs browsers](../.gitbook/assets/image%20%2896%29.png)
...
![TestProject Monitor showing the progress of currently running test on Sauce Labs Edge 44 browser](../.gitbook/assets/image%20%28107%29.png)
...
![A TestProject report of the &quot;Login&quot; test that was executed on Sauce Labs Edge browser](../.gitbook/assets/image%20%28156%29.png)
...
![Sauce Labs &quot;Login&quot; test execution information](../.gitbook/assets/image%20%28230%29.png)
