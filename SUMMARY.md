...
* [Start Android Emulator using Android studio](<articles/Start Android Emulator using Android studio/README.md>)
  * [Empty Cache and Hard Reload](<articles/Start Android Emulator using Android studio/Empty Cache and Hard Reload.md>)
* [Discord Webhook integration](<articles/Discord Webhook integration/README.md>)
  * [Download HAR file](<articles/Discord Webhook integration/Download HAR file.md>)
* [Passing multiple browsers capabilities in a single job](<articles/Passing multiple browsers capabilities in a single job/README.md>)
  * [UIAutomator - Power Consumption](<articles/Passing multiple browsers capabilities in a single job/UIAutomator - Power Consumption.md>)
* [Using Firefox Profile with Selenium Desired capabilities - Permissions & Extensions](<articles/Using Firefox Profile with Selenium Desired capabilities - Permissions & Extensions/README.md>)
  * [TestProject Agent Logs](<articles/Using Firefox Profile with Selenium Desired capabilities - Permissions & Extensions/TestProject Agent Logs.md>)
* [Execute a flow based on Datasource - Data Driven testing](<articles/Execute a flow based on Datasource - Data Driven testing/README.md>)
  * [Connect Android Device to TestProject](<articles/Execute a flow based on Datasource - Data Driven testing/Connect Android Device to TestProject.md>)
* [Microsoft Teams Webhook integration](<articles/Microsoft Teams Webhook integration.md>)
* [Sharing multiple tests in TestProject](<articles/Sharing multiple tests in TestProject.md>)
* [Automation Flakiness - quick fixes](<articles/Automation Flakiness - quick fixes.md>)
* [Managing IT restrictions using TestProject CLI (command-line interface)](<articles/Managing IT restrictions using TestProject CLI (command-line interface).md>)
* [How to perform X,Y clicks with TestProject](<articles/How to perform X,Y clicks with TestProject.md>)
