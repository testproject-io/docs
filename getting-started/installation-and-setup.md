...
![TestProject Agent on Windows](../.gitbook/assets/image%20%2877%29.png)
...
![TestProject Status in System Tray](../.gitbook/assets/image%20%282%29.png)
...
![TestProject Agent on Mac](../.gitbook/assets/image%20%2810%29.png)

### Linux

On Linux you will need to run the `TestProjectAgent` command from the `testproject/agent` folder

![Starting TestProject agent on Linux](../.gitbook/assets/image%20%2869%29.png)
...
![Register an Agent](../.gitbook/assets/image%20%2847%29.png)
