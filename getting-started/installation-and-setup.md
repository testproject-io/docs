...
![TestProject Agent on Windows](../.gitbook/assets/image%20%28146%29.png)
...
![TestProject Agent on Mac](../.gitbook/assets/image%20%2821%29.png)

### Linux

On Linux you will need to run the `TestProjectAgent` command from the `testproject/agent` folder

![Starting TestProject agent on Linux](../.gitbook/assets/image%20%28131%29.png)
...
![Register an Agent](../.gitbook/assets/image%20%2884%29.png)
