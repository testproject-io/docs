...
![TestProject Agent on Windows](../.gitbook/assets/image%20%28135%29.png)
...
![TestProject Agent on Mac](../.gitbook/assets/image%20%2819%29.png)

### Linux

On Linux you will need to run the `TestProjectAgent` command from the `testproject/agent` folder

![Starting TestProject agent on Linux](../.gitbook/assets/image%20%28122%29.png)
...
![Register an Agent](../.gitbook/assets/image%20%2878%29.png)
