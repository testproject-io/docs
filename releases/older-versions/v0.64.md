...
* **Execution Progress** - The [job execution state endpoint](https://api.testproject.io/docs/v2/#/Jobs/Jobs\_GetJobExecutionStateAsync) will now return a progress property during execution. The progress will contain the _X_ of _N_ _device _/_browser_, _test_ and _step_.
